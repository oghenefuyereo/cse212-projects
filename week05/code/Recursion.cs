...
public static class Recursion
{
    ...
    public static void PermutationsChoose(List<string> results, string letters, int size, string word = "")
    {
        ...
        {
            // choose current letter and recurse with remaining letters
            string nextLetters = letters.Remove(i, 1);
            PermutationsChoose(results, nextLetters, size, word + letters[i]);
        }
    }
    ...
    /// # Problem 4 #
    /// #############
    /// Generate all binary strings from a pattern containing wildcards *
    /// </summary>
    ...
    /// # Problem 5 #
    /// #############
    /// Solve a maze recursively and record all paths
    /// </summary>
